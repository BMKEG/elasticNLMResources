 ...
 * 
 */
public class ESNLM_01_BuildOpenAccessCorpusFromPmidListFile {
	...
	private static final Logger logger = LoggerFactory.getLogger(ESNLM_01_BuildOpenAccessCorpusFromPmidListFile.class);
